...
var decryptQuery = encryption.decryptQuery;
console.log(encryption, process.env.MODELS_CRYPTO_KEY);
...
function BaseSchema(){
  ...
  this.add({
    ...
    email: { type: String, lowercase: true, get: decrypt, set: encrypt},
    gender: {type: String},
...
// decryptQuery takes a query and encrypts the properties that are encrypted in the database
// TODO: Test the {} case
...
BaseUserSchema.pre('findOne', function(next) {
  this._conditions = decryptQuery(this._conditions);
  next();
});
