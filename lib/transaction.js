...
//   var hingeTransactionAmount = typeof hingeTransaction.amount === 'number' ? hingeTransaction.amount : hingeTransaction.amount.amount;


//   // both from Yodlee
//   if (this.__t === 'YodleeTransaction' && hingeTransaction.__t === 'YodleeTransaction'){
//     return sourceAmount === hingeTransactionAmount && this.baseType === "CREDIT" && hingeTransaction.baseType === "DEBIT";  
//   }
...
//     // positive is outflow, credit is inflow 
//     if (this.__t === 'YodleeTransaction' && hingeTransaction.amount > 0 && this.baseType === "CREDIT") {
//       inverse = true; 
//     }
    
//     // postive number === outflow === spent 
//     else if (this.__t === 'PlaidTransaction' && hingeTransaction.baseType === "DEBIT" && this.amount < 0){
//       inverse = true; 
//     }
...
//     // absolute value is the same and the hinge is positive (outflow) and the `this` is negative (inflow)
//     return this.amount === (-1*hingeTransaction.amount) && hingeTransaction.amount > 0 && this.amount < 0;
//   }
// }
