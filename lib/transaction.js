...
function BaseSchema(){
  ...
  this.add({
    ...
    includeInCalculations: {type: Boolean, default: true}, // do not send transactions down to front end
    userDeleted: {type: Boolean, default: false}, // transaction has been deleted by user, do not show to user
    userHidden: {type: Boolean, default: false}, // transactions should show up in users all feed but not be included in calculations
    doNotCategorize: {type: Boolean, default: false},
    codeThree: {type: Boolean}, 
    manufactured: {type: Boolean},
    forceTransferToBeInverseCandidate: {type: Boolean},
    doNotModify: {type: Array, default: []}
  })
}
...
BaseTransactionSchema.index({"__t": 1, "plaidId": 1})
BaseTransactionSchema.index({"__v": 1, "_id": 1})
BaseTransactionSchema.index({"__v": 1, "inverse._id": 1})
BaseTransactionSchema.index({"absAmount": 1, "date": 1, "name": 1})
BaseTransactionSchema.index({"__t": 1, "institution": 1, "user": 1, "momentDate": 1})
BaseTransactionSchema.index({"__t": 1, "user": 1, "doNotCategorize": 1, "includeInCalculations": 1})
BaseTransactionSchema.index({"__t": 1, "plaidAccountId": 1})
