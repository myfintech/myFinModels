...
BaseTransactionSchema.methods.isCreditSideOfTransfer = function(){
  return this.isCredit() && this.category_id === "21005000" && Array.isArray(this.name.match(/transfer/i)); 
}
...
// multi field index 
BaseTransaction.index({"__t": 1, "institution": 1, "user": 1, "dateCreated": 1})
