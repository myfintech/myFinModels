...
function BaseSchema(){
  ...
  this.add({
    ...
    date: String, 
    institutionCounterpart: {type: Schema.Types.ObjectId, ref: 'BaseInstitution'},
...
BaseTransactionSchema.methods.isMovingMoneyIntoInstitutionThatGetsIncompleteCreditTransactions = function(){
  ...
  return this.isDebit() && (["30671", "7298"].indexOf(this.targetId) > -1 || ["30671", "7298"].indexOf(this.sourceInstitutionId) > -1); 
}
...
BaseTransactionSchema.methods.addAccountCounterpart = function(user){
  var accountIds = Object.keys(user.sourceAccountIdToAccountIdToMyFinInstitutionIdMap); 
