...
/// figure out right Path!
var plaidInstitutionIdToMyFinIntitutionIdMapForSocialInstitutions = require(path.join(__dirname + '../../../../../components/plaidInstitutionIdToMyFinInstitutionIdMapForSocialInstitutions.json'))
var yodleeInstitutionIdToMyFinIntitutionIdMapForSocialInstitutions = require(path.join(__dirname + '../../../../../components/yodleeInstitutionIdToMyFinInstitutionIdMapForSocialInstitutions.json'))
...
//   var amount = typeof this.amount === 'object' ? this.amount.amount : this.amount; 
//   return ( this.__t === 'PlaidTransaction' && amount > 0 ) || (this.__t === "YodleeTransaction" && this.baseType === "DEBIT"); 
// }

// BaseTransactionSchema.methods.isCredit = function(){
//   var amount = typeof this.amount === 'object' ? this.amount.amount : this.amount; 
//   return ( this.__t === 'PlaidTransaction' && amount < 0 ) || (this.__t === "YodleeTransaction" && this.baseType === "CREDIT"); 
// }
...
BaseTransactionSchema.methods.createInverseDocument = function(){
  ...
  if (this.inverseToBeCreated.__t === "PlaidTransaction") this.inverseToBeCreated.plaidInstitutionId = this.targetId;  
...
and so it must be going into an account that belongs to a social payment institution
...
BaseTransactionSchema.methods.markAsFromFriendsOrMade = function(){
  ...
  if (this.__t === 'PlaidTransaction') {
    ...
    // 
    intoLinkedSocialPaymentAccount = plaidInstitutionIdToMyFinIntitutionIdMapForSocialInstitutions[this.institution]; 
    ...
    // it is going INTO a venmo, paypal, coinbase, dwolla, or chase quickpay account
    intoLinkedSocialPaymentAccount = yodleeInstitutionIdToMyFinIntitutionIdMapForSocialInstitutions[this.institution]; 
