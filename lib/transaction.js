...
BaseTransactionSchema.methods.isNotFromDiscreditingInstitution = function(){
  var categoryIds = ["21010001", "21010003", "21010004", "21010005", "21010006", "21010007", "21010008", "21010009", "21010010"];
  return categoryIds.indexOf(this.category_id) === -1;
};
...
BaseTransactionSchema.methods.isTransferToWealthfront = function(){
  return this.isDebit() &&  ( /apex clearing ach/i.test(this.name) || /apex clearing/i.test(this.name)  ); 
};
